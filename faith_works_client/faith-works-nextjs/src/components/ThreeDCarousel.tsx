        ...
        {items.map((item, index) => (
          ...
          >
            <BorderGlow
              ...
              borderRadius={26}
              glowColor="330 60 75"
              colors={['#EFACBA', '#FCE82A', '#f9a8d4']}
              glowRadius={56}
              glowIntensity={3.0}
              coneSpread={20}
              animated
              style={{ height: cardHeight, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}
            >
              {/* Image header */}
              <div
              ...
              <CardContent className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-4">
                  ...
                  >
                    ...
                    <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-gray-500 transition-all duration-300 group-hover:w-full" />
                  </Link>
                </div>
              </CardContent>
            </BorderGlow>
